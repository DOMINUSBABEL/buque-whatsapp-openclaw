/**
 * BUQUE WHATSAPP BOT (OPENCLAW ENTRYPOINT)
 * Initializes the full WhatsApp B2B Autonomous Swarm server,
 * onboarding wizard, preview server, and bidirectional messaging router.
 */
...
async function startServer() {
  console.clear();
  console.log('🚢 Initializing Buque B2B Swarm Server...');
